...
public class MAXSwerveModule {
  ...
  private final SparkClosedLoopController m_drivingPIDController; // PID
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    // new -- make configs
    SparkMaxConfig config_driving = new SparkMaxConfig();
    SparkMaxConfig config_turning = new SparkMaxConfig();
